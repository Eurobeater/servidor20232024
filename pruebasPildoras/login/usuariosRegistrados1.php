...
<body>
    ...
    <?php
        echo "Hola: " .$_SESSION['usuario']. "<br><br>";          //usamos la variable superglobal $SESSION con parametro 'usuario' para mostrar el nombre del usuario que ha iniciado sesión y almacenado en dicha variable
    ?>
