...
function processForm( $campos ) 				//al hacer click en Enviar, se llama
{
	...
	foreach ( $campos as $campo ) 
	{
		...
		{
			$missingFields[] = $campo[ 'nombre' ];			//si el campo nombre no existe o no pasa la validación, se añade al array $missingFields[]
		}
...
function displayResultados()				//si los campos que pasan la validación, llama a esta función
{
...
function displayEntrada( $missingFields )			//visualización de errores. los campos que no pasaron la validación (que se encuentran en missingFields) se resaltan en rojo con la clase CSS 'error'
{
