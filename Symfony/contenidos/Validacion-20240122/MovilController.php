...
{   
    ...
    public function clase( EntityManagerInterface $entityManager, Request $request )
    {
    ...
    #[Route("/movil_constraint", name:"movil_constraint")]
    public function constraint( EntityManagerInterface $entityManager,Request $request )
    {
