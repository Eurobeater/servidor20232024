...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-02-2024 a las 03:33:10
...
INSERT INTO `respuesta` (`id`, `pregunta_id`, `respuesta`, `orden`) VALUES
(1, 1, 'Muy Buena', 0),
(2, 1, 'Buena', 0),
(3, 1, 'Mala', 0),
(4, 1, 'Prefiero no constestar', 0),
(5, 2, 'Mala', 0),
(6, 2, 'Prefiero no constestar', 0),
(7, 2, 'Muy Buena', 0),
(8, 2, 'Buena', 0);
